...
COMMANDS_BUTTON_USER = InlineKeyboardMarkup(
    [   [
        ...
        [
            ...
            InlineKeyboardButton(
                text="Extra Commands", url="https://telegra.ph/Lyra-Music-Help-Commands-05-18"
            ),                                   
        ],
        [
            InlineKeyboardButton(
...
COMMANDS_BUTTON_SUDO = InlineKeyboardMarkup(
    [   [
        ...
        [
            ...
            InlineKeyboardButton(
                text="Sudo Commands", url="https://telegra.ph/Lyra-Sudo-cmds-05-18"
            ),            
        ],
        [
            InlineKeyboardButton(
...
/sudolist - Check Sudo Users of Lyra Music Bot

...
from LyraMusic.misc import SUDO_USERS as SUDOERS
from LyraMusic.plugins.xcodebots.database.limitsdb import add_to_approved_user, remove_approved_user, get_approved_users, is_approved
...
async def userapprove(client, message: Message, _):
    if MONGO_DB_URI is None:
        return await message.reply_text(
            "**Due to bot's privacy issues, You can't manage sudo users when you're using Lyra's Database.\n\n Please fill your MONGO_DB_URI in your vars to use this feature**"
        )

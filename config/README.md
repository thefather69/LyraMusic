...
- These are the minimum required vars need to setup to make Lyra Music Bot functional.
...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@LyraStringBot](http://t.me/LyraStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from Lyra Music bot
...
- If you plan to use Lyra Music Bot with your own customized or modified code.
...
- You can change images which are used in Lyra Music Bot.
- You can generate telegaph links from [@LyraTelegraphBot](http://t.me/LyraTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@LyraStringBot](http://t.me/LyraStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@LyraStringBot](http://t.me/LyraStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@LyraStringBot](http://t.me/LyraStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@LyraStringBot](http://t.me/LyraStringBot) in Telegram.
